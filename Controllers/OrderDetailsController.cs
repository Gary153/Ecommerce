...
namespace Ecommerce.Controllers
{
    public class OrderDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "DetailsId,OrderId,ProductId,DetailsName,DetailsPrice,DetailsQuantity")] OrderDetail orderDetail)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "DetailsId,OrderId,ProductId,DetailsName,DetailsPrice,DetailsQuantity")] OrderDetail orderDetail)
        {
            if (ModelState.IsValid)
            {
